...
<html>
    ...
    <body>
        <?php 
            ...
            "Crear base de datos"=>$this->crearRuta(["controlador"=>"menu","accion"=>"crearbasedatos"]),
            "Crear tabla"=>$this->crearRuta(["controlador"=>"menu","accion"=>"creartabla"]),
            "Borrar tabla"=>$this->crearRuta(["controlador"=>"menu","accion"=>"borrartabla"]),
        ]));
